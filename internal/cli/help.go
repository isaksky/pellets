...
var optionHelp = map[string]string{
	...
	"--model":                        "Execution model for this pellet; otherwise inherit execution defaults.",
	"--reasoning-effort":             "Execution reasoning effort for this pellet.",
	"--clear-model":                  "Inherit the execution model default.",
	"--clear-reasoning-effort":       "Inherit the execution reasoning effort default.",
