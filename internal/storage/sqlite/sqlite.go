...
//go:embed migrations/0006_workspace_run_settings.sql
...
//go:embed migrations/0009_execution_finalization.sql
var migration9SQL string

//go:embed migrations/0010_execution_interactions.sql
var migration10SQL string

//go:embed migrations/0011_execution_recovery.sql
var migration11SQL string

//go:embed migrations/0012_review_checkpoints.sql
var migration12SQL string

//go:embed migrations/0013_review_execution.sql
var migration13SQL string

//go:embed migrations/0014_checkpoint_triage.sql
...
//go:embed migrations/0022_execution_group_context.sql
var migration22SQL string

//go:embed migrations/0023_checkpoint_context_digest.sql
var migration23SQL string

//go:embed migrations/0024_model_catalog.sql
var migration24SQL string

//go:embed migrations/0025_pellet_execution_preferences.sql
var migration25SQL string

//go:embed migrations/0026_review_completed_implementations.sql
...
var migrations = []migration{
	...
	{version: 9, name: "execution-finalization", sql: migration9SQL, assert: assertMigration9, preflight: assertMigration9, ftsIndexes: []string{"pellets_fts", "memories_fts"}},
	{version: 10, name: "execution-interactions", sql: migration10SQL, assert: assertMigration10, preflight: assertMigration10, ftsIndexes: []string{"pellets_fts", "memories_fts"}},
	{version: 11, name: "execution-recovery", sql: migration11SQL, assert: assertMigration11, preflight: assertMigration11, ftsIndexes: []string{"pellets_fts", "memories_fts"}},
	{version: 12, name: "review-checkpoints", sql: migration12SQL, assert: assertMigration12, preflight: assertMigration12, ftsIndexes: []string{"pellets_fts", "memories_fts"}},
	...
	{version: 22, name: "execution-group-context", sql: migration22SQL, assert: assertMigration22, preflight: assertMigration22, ftsIndexes: []string{"pellets_fts", "memories_fts"}},
	{version: 23, name: "checkpoint-context-digest", sql: migration23SQL, assert: assertMigration23, preflight: assertMigration23, ftsIndexes: []string{"pellets_fts", "memories_fts"}},
	{version: 24, name: "model-catalog", sql: migration24SQL, assert: assertMigration24, preflight: assertMigration24, ftsIndexes: []string{"pellets_fts", "memories_fts"}},
	{version: 25, name: "pellet-execution-preferences", sql: migration25SQL, assert: assertMigration25, preflight: assertMigration25, ftsIndexes: []string{"pellets_fts", "memories_fts"}},
	{version: 26, name: "review-completed-implementations", sql: migration26SQL, assert: assertMigration26, preflight: assertMigration26, ftsIndexes: []string{"pellets_fts", "memories_fts"}},
}
...
func assertMigration6(ctx context.Context, conn *sql.Conn) error {
	return verifyProductionSchemaContract(ctx, conn, 6)
}
...
func assertMigration9(ctx context.Context, conn *sql.Conn) error {
	return verifyProductionSchemaContract(ctx, conn, 9)
}

func assertMigration10(ctx context.Context, conn *sql.Conn) error {
	return verifyProductionSchemaContract(ctx, conn, 10)
}

func assertMigration11(ctx context.Context, conn *sql.Conn) error {
	return verifyProductionSchemaContract(ctx, conn, 11)
}

func assertMigration12(ctx context.Context, conn *sql.Conn) error {
	return verifyProductionSchemaContract(ctx, conn, 12)
}

func assertMigration13(ctx context.Context, conn *sql.Conn) error {
	return verifyProductionSchemaContract(ctx, conn, 13)
}

func assertMigration14(ctx context.Context, conn *sql.Conn) error {
	return verifyProductionSchemaContract(ctx, conn, 14)
}
...
func assertMigration22(ctx context.Context, conn *sql.Conn) error {
	return verifyProductionSchemaContract(ctx, conn, 22)
}

func assertMigration23(ctx context.Context, conn *sql.Conn) error {
	return verifyProductionSchemaContract(ctx, conn, 23)
}

func assertMigration24(ctx context.Context, conn *sql.Conn) error {
	return verifyProductionSchemaContract(ctx, conn, 24)
}

func assertMigration25(ctx context.Context, conn *sql.Conn) error {
	return verifyProductionSchemaContract(ctx, conn, 25)
}

func assertMigration26(ctx context.Context, conn *sql.Conn) error {
	return verifyProductionSchemaContract(ctx, conn, 26)
}
