...
func buildProductionSchemaContracts() {
	...
	endpoints := []struct {
		...
		{version: 13, name: "review-execution", sql: migration13SQL},
		{version: 14, name: "checkpoint-triage", sql: migration14SQL},
		{version: 15, name: "no-change-completion", sql: migration15SQL},
		{version: 16, name: "workspace-group-assignments", sql: migration16SQL},
		{version: 17, name: "checkpoint-management", sql: migration17SQL},
		{version: 18, name: "live-implementation-changes", sql: migration18SQL},
		{version: 19, name: "planning-chats", sql: migration19SQL},
		{version: 20, name: "settings", sql: migration20SQL},
		{version: 21, name: "project-groups", sql: migration21SQL},
		...
		{version: 26, name: "review-completed-implementations", sql: migration26SQL},
	}
